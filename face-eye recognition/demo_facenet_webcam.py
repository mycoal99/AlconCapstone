...
# videoSource = "rtsp://<username>:<password>@<staticIP>
        ...
        while True:
            ...
            for x in range(1): 
	            ...
	            try:
	                ...
	                # draw on frame
	                self._draw(frame, boxes, probs, landmarks, 1, debugging)
	                i += 1
            ...
            if debugging:
                # frame = cv2.rotate(frame,cv2.ROTATE_90_CLOCKWISE)
                name = "C:\\Users\\Michael\\Desktop\\video\\demo1-"+ str(picCapture) + ".png"
    ...
    def start(self, videoSource=videoSources["iv"], debugging=True, framesActive= 10):
...
if __name__ == "__main__":
    ...
    writer = imageio.get_writer(write_to, format='mp4', mode='I', fps=5)

...
import numpy as np
import cv2
from segmentation.circlecoords import circlecoords

# print("NORMALIZE")
##-----------------------------------------------------------------------------
##  Function
##-----------------------------------------------------------------------------
def normalizeiris(image, x_iris, y_iris, r_iris, x_pupil, y_pupil, r_pupil,
	...
	# cv2.imwrite("withcircle.png", image)
